...
function addEvals(letters) {
  for (let i = 0; i < currentRow(); i++) {
    for (let j = 0; j < 5; j++) {
      ...
      letters[j][tile.getAttribute('evaluation')].push(tile);
    }
  }
}
...
// function solve() {
//   if (currentRow() != 0) return; // for now

//   while (!correct() && currentRow() <= 5) {
//     if (currentRow() == 0) {
//       typeWord('audio');
//     } else {
//       const possibleWords = [...words]
//       typeWord(possibleWords[Math.floor(Math.random() * possibleWords.length)]); // random word from possible
//     }
//     addEvals(0);
//   }
// }
